...
const PLANS = [
  {
    ...
    price: "$9.99",
    scenes: 2,
    features: ["2 Veo scenes", "Title card overlay", "ElevenLabs VO", "Brand colors"],
    cta: "Get Started",
    highlight: false,
  },
  {
    ...
    price: "$19.99",
    scenes: 4,
    features: ["4 Veo scenes", "Title + 4 captions + CTA", "ElevenLabs VO", "Brand colors", "Edit & re-run"],
    cta: "Most Popular",
    highlight: true,
  },
  {
    ...
    price: "$29.99",
    scenes: 8,
    features: ["8 Veo scenes", "Full overlay suite", "ElevenLabs VO", "Brand colors", "Edit & re-run"],
    cta: "Go Deep",
    highlight: false,
  },
];
